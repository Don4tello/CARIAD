-- DROP view reporting.v_company_targets CASCADE; 
Create view reporting.v_company_targets as
...
,personal_grading_category		
,case when personal_grading_category in
('CARIAD Executive','Corporate Management','Group Executive')
  then 'Management' else personal_grading_category end
  role_level  
,mitarbeitergruppe			
,mitarbeiterkreis			
,cost_center_id			
...
Select 
 ...
 final.importdate					
,final.personalnumber_id			
--,final.cariad			
--,final.vs			
--,final.oe_1										
--,final.role_level		
--,final.mitarbeitergruppe			
--,final.mitarbeiterkreis						
--,final.nationality				
--,final.gender			
--,final.age				
--,final.disability			
--,final.salary_level			
--,final.salary_section
          
-- cariad_group Targets
,(cariad_group.target_female) AS target_female_cariad_group
,(cariad_group.ambition_female) AS ambition_female_cariad_group
,(cariad_group.target_international) AS target_international_cariad_group
,(cariad_group.ambition_international) AS ambition_international_cariad_group
          
-- target_cariad_group_role_level Targets
,(cariad_group_mgmt_level.target_female) AS target_female_cariad_group_mgmt_level
,(cariad_group_mgmt_level.ambition_female) AS ambition_female_cariad_group_mgmt_level
,(cariad_group_mgmt_level.target_international) AS target_international_cariad_group_mgmt_level
,(cariad_group_mgmt_level.ambition_international) AS ambition_international_cariad_group_mgmt_level          

-- subsidiary_total Targets
,(sub.target_female) AS target_female_subsidiary
,(sub.ambition_female) AS ambition_female_subsidiary
,(sub.target_international) AS target_international_subsidiary
,(sub.ambition_international) AS ambition_international_subsidiary       

-- subsidiary role level Targets
,(sub_role_level.target_female) AS target_female_subsidiary_mgmt_level
,(sub_role_level.ambition_female) AS ambition_female_subsidiary_mgmt_level
,(sub_role_level.target_international) AS target_international_subsidiary_mgmt_level
,(sub_role_level.ambition_international) AS ambition_international_subsidiary_mgmt_level  
                  
-- Vorstand Targets
,(vorstand.target_female) AS target_female_vs
,(vorstand.ambition_female) AS ambition_female_vs
,(vorstand.target_international) AS target_international_vs
,(vorstand.ambition_international) AS ambition_international_vs
                  
-- vorstand_role_level Targets
,(vorstand_role_level.target_female) AS target_female_vs_role_level
,(vorstand_role_level.ambition_female) AS ambition_female_vs_role_level
,(vorstand_role_level.target_international) AS target_international_vs_role_level
,(vorstand_role_level.ambition_international) AS ambition_international_vs_role_level 

-- vs_oe_level Targets
,(oe_level.target_female) AS target_female_vs_oe_1
,(oe_level.ambition_female) AS ambition_female_vs_oe_1
,(oe_level.target_international) AS target_international_vs_oe_1
,(oe_level.ambition_international) AS ambition_international_vs_oe_1
                  
-- vs_oe_role_level Targets
,(oe_role_level.target_female) AS target_female_vs_oe_1_mgmt_level
,(oe_role_level.ambition_female) AS ambition_female_vs_oe_1_mgmt_level
,(oe_role_level.target_international) AS target_international_vs_oe_1_mgmt_level
,(oe_role_level.ambition_international) AS ambition_international_vs_oe_1_mgmt_level
                  
          from final

-- Cariad Group Targets Join          
left join core.diversity_targets cariad_group on 
cariad_group.subsidiary IS NULL 
AND cariad_group.vs IS NULL
AND cariad_group.oe_1 IS NULL
AND cariad_group.role_level IS NULL
AND CAST (cariad_group.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))

-- cariad_group_mgmt_level Targets Join          
left join core.diversity_targets cariad_group_mgmt_level on 
cariad_group_mgmt_level.subsidiary IS NULL 
AND cariad_group_mgmt_level.vs IS NULL
AND cariad_group_mgmt_level.oe_1 IS NULL
AND cariad_group_mgmt_level.role_level IS NOT NULL
AND CAST (cariad_group_mgmt_level.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))    
AND cariad_group_mgmt_level.role_level = final.role_level

-- Subsidiary Targets Join          
left join core.diversity_targets sub on 
sub.subsidiary IS NOT NULL 
AND sub.vs IS NULL
AND sub.oe_1 IS NULL
AND sub.role_level IS NULL
AND CAST (sub.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))
          
-- Subsidiary role_level Targets Join          
left join core.diversity_targets sub_role_level on 
sub_role_level.subsidiary IS NOT NULL 
AND sub_role_level.vs IS NULL
AND sub_role_level.oe_1 IS NULL
AND sub_role_level.role_level IS NOT NULL
AND CAST (sub_role_level.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))
AND sub_role_level.role_level = final.role_level       
                                                                     
-- vorstand join         
left join core.diversity_targets vorstand on 
vorstand.subsidiary IS NOT NULL 
AND vorstand.vs IS NOT NULL
AND vorstand.oe_1 IS NULL
AND vorstand.role_level IS NULL
AND CAST (vorstand.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))
AND vorstand.vs = final.vs                                                                                                                                              
                                                                 
-- vorstand_role_level join         
left join core.diversity_targets vorstand_role_level on 
vorstand_role_level.subsidiary IS NOT NULL 
AND vorstand_role_level.vs IS NOT NULL
AND vorstand_role_level.oe_1 IS NULL
AND vorstand_role_level.role_level IS NOT NULL
AND CAST (vorstand_role_level.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))
AND vorstand_role_level.vs = final.vs
AND vorstand_role_level.role_level = final.role_level                                                                                                                           

-- oe_level join         
left join core.diversity_targets oe_level on 
oe_level.subsidiary IS NOT NULL 
AND oe_level.vs IS NOT NULL
AND oe_level.oe_1 IS NOT NULL
AND oe_level.role_level IS NULL
AND CAST (oe_level.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))
AND oe_level.oe_1 = final.oe_1  
                                                                 
-- oe_role_level join         
left join core.diversity_targets oe_role_level on 
oe_role_level.subsidiary IS NOT NULL 
AND oe_role_level.vs IS NOT NULL
AND oe_role_level.oe_1 IS NOT NULL
AND oe_role_level.role_level IS NOT NULL
AND CAST (oe_role_level.year as varchar)||'-01-01' = TRUNC(DATE_TRUNC('year', final.importdate))
AND oe_role_level.oe_1 = final.oe_1
and oe_role_level.role_level = final.role_level                                                                      
